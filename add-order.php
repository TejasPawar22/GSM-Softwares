        ...
        <div class="page-wrapper">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST" action="php_action/createInvoice.php" id="createOrderForm">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                              ...
                                              <label class="col-sm-2 control-label">Invoice No</label>
                                               <div class="col-sm-4">
                                                <input type="text" name="invoiceNo" class="form-control" value="<?php echo 'GSM' .
                                                    rand(
                                                        10,
                                                        100
                                                    ); ?>" placeholder="Invoice Number" autocomplete="off" required/>
                                               </div>
          ...
          <tbody>
            ...
            for ($x = 1; $x < 2; $x++) { ?>
              <tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">                
                <td style="margin-left:20px;">
                  ...
                  <select class="form-control" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
                    ...
                    <?php
                    $productSql =
                        'SELECT * FROM product WHERE active = 1 AND status = 1 AND quantity != 0 AND company_id="' .
                        $_SESSION['company_id'] .
                        '"';
              ...
              <td style="padding-left:20px;">
                  <div class="form-group">
                  <p style="font-size:20px" id="available_quantity<?php echo $x; ?>"></p>
                  </div>
                </td>
                <td style="padding-left:20px;">
                  <div class="form-group">
