...
$sql = "SELECT brand_id, brand_name, brand_active, brand_status FROM brands WHERE brand_status = 1 and company_id='$_SESSION[company_id]'";
                                       ...
                                       <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="php_action/removeBrand.php?id=<?php echo $row[
                                                    'brand_id'
