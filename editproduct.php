                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    <form action="php_action/editProductImage.php?id=<?php echo $_GET[
                                        'id'
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                   ...
                                                   <img src="assets/myimages/<?php echo $result[
                                                       'product_image'
                                                   ]; ?>" style="width:250px; height:250px;" >
                                                     <input type="hidden" name="old_image" value="<?php echo $result[
                                                         'product_image'
                                                     ]; ?>">
                ...
                <div class="col-sm-9">
                  ...
                  <div class="kv-avatar center-block">                  
                      <input type="file" class="form-control" id="productImage" placeholder="Product Name" name="productImage" class="file-loading" style="width:auto;"/>
                                     ...
                                     <form class="form-horizontal" method="POST"  id="submitProductForm" action="php_action/editProduct.php?id=<?php echo $_GET[
                                         'id'
                                    ...
                                    <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" class="form-control" id="editProductName" value="<?php echo $result[
                                                      'product_name'
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" class="form-control" id="editQuantity" value="<?php echo $result[
                                                      'quantity'
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                   <input type="text" class="form-control" id="editRate" value="<?php echo $result[
                                                       'rate'
...
while ($rows = mysqli_fetch_assoc($results)) { ?>
     <option value="<?php echo $rows['brand_id']; ?>"<?php if (
    $result['brand_id'] == $rows['brand_id']
) {
    echo 'selected';
...
<?php
$sql = 'SELECT * FROM categories  where categories_status=1 '; //echo $sql;exit;
$result1 = mysqli_query($connect, $sql); //echo "23";exit;
while ($row = mysqli_fetch_assoc($result1)) { ?>
     <option value="<?php echo $row['categories_id']; ?>"<?php if (
...
?></select>
                        ...
                        <option value="1" <?php if ($result['active'] == '1') {
                            echo 'selected';
                        } ?>>Available</option>
