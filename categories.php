...
$sql = "SELECT categories_id, categories_name, categories_active, categories_status FROM categories WHERE categories_status = 1 and company_id='$_SESSION[company_id]'";
                                       ...
                                       <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="php_action/removeCategories.php?id=<?php echo $row[
                                                    'categories_id'
